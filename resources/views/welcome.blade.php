        ...
        <main class="l-main">
            ...
            <section class="about section bd-container" id="tentangkami">
                <div class="about__container  bd-grid">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/SVcPPpH3XvU?modestbranding=1&autoplay=0 " class="about__img" title="TITLE" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </section>
        </main>
